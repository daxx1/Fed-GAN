...
for n in range(section):
    ...
    for i in range(100000):
        ...
        #print(label3[i])
        #print(list_inx[n])
        for z in range(len(list_inx[n][label3[i]])):
            nimi_inx = list_inx[n][label3[i]][z]
    ...
    votes_inx[n] = lis
np.savetxt(r"F:\test/votes_inx_mnist_79.05_eps10_fen2_0-1000.txt", np.asarray(votes_inx), delimiter=",",fmt="%d")
import sys
sys.exit()
